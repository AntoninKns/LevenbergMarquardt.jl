export levenberg_marquardt_tr_AD, levenberg_marquardt_tr_AD!

"""
Algorithm of TR Levenberg Marquardt based on 
"""
function levenberg_marquardt_tr_AD(model; kwargs...)
  solver = LMSolverAD(model)
  levenberg_marquardt_tr_AD!(solver, model; kwargs...)
  return solver.stats
end
...
Algorithm of TR Levenberg Marquardt based on
"""
function levenberg_marquardt_tr_AD!(solver    :: LMSolverAD{T,S}, 
