...
function ADBundleAdjustmentModel(model::BundleAdjustmentModel)
  ...
  resid!(rx, x) = BundleAdjustmentModels.residuals!(model.cams_indices, model.pnts_indices, x, rx, model.nobs, model.npnts, k, P1)
  ...
  resid_fwd!(rx, x) = BundleAdjustmentModels.residuals!(model.cams_indices, model.pnts_indices, x, rx, model.nobs, model.npnts, k_fwd, P1_fwd)
  ...
  resid_rev!(rx, x) = BundleAdjustmentModels.residuals!(model.cams_indices, model.pnts_indices, x, rx, model.nobs, model.npnts, k_rev, P1_rev)

  return ReverseADNLSModel(resid!, model.nls_meta.nequ, model.meta.x0, r_fwd! = resid_fwd!, r_rev! = resid_rev!)
end